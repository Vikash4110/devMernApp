      ...
      <main className="bg-gray-100">
        <section className="flex flex-col lg:flex-row items-center justify-between p-8 bg-gradient-to-r from-indigo-500 to-blue-500 text-white">
          <div className="lg:w-1/2 space-y-4" data-aos="fade-right">
            ...
            <h1 className="text-5xl font-bold">Welcome to Vikash Bharal</h1>
            <p className="text-lg">
              Are you ready to take your business to the next level with cutting-edge IT solutions? Look no further! At Vikash Bharal, we specialize in providing innovative IT services and solutions tailored to meet your unique needs.
            </p>
